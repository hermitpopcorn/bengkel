...
--
-- Host: localhost
-- Generation Time: Jun 23, 2016 at 10:34 AM
...
(1, NULL, 'Federal Matic', 'FEDERAL', 'OLI', 40000, 10),
(2, NULL, 'Top One MT', 'TOP ONE', 'OLI', 50000, 10),
(3, NULL, 'Busi generik', 'GENERIK', 'BUSI', 20000, 5);
...
CREATE TABLE `penjualan` (
  ...
  `karyawan_pencatat` int(10) UNSIGNED NOT NULL,
  `biaya_service` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
