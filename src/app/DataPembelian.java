...
public class DataPembelian extends javax.swing.JInternalFrame {
     ...
     */
    public DataPembelian(int idKaryawan) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(47, 47, 47)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(dcTanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                    .addComponent(tfId)
                    .addComponent(tfNama)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbBarang, 0, 255, Short.MAX_VALUE)
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        Object[] data = {tfId.getText(), tfNama.getText(), dcTanggal.getDate(),
        ...
        try {
            String[] waktu = ((String) data[3]).split(":");
            ((Date) data[2]).setHours(Integer.valueOf(waktu[0]));
            ((Date) data[2]).setMinutes(Integer.valueOf(waktu[1]));
        } catch(NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Waktu tidak valid.");
            return;
        }
        
        boolean save = transaksiModel.savePembelian((int) data[0], (String) data[1], (Date) data[2], (ArrayList<Integer>) data[4], (ArrayList<Integer>) data[5], (ArrayList<BigDecimal>) data[6]);
        if(save) {
            clear();
